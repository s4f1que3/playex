    ...
    <AnimatePresence>
      {showConsent && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4 backdrop-blur-sm"
        >
          {/* Backdrop */}
          <motion.div 
            initial={{ opacity: 0 }}
          ...
          >
            <div className="relative bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl">
              ...
              {/* Actions */}
              <div className="relative p-6 bg-black/20 border-t border-white/5 flex flex-col sm:flex-row-reverse gap-3">
                <motion.button
