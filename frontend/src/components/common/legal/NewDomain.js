              ...
              <div className="relative flex flex-col h-full max-h-[calc(90vh-8rem)]">
                ...
                <div className="relative p-6 border-b border-white/10 flex-shrink-0">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white">Domain Notice</h3>
                      <p className="text-gray-400 text-sm">Recent Announcement</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative p-6 space-y-6 overflow-y-auto">
                  <p className="text-gray-300 leading-relaxed">
                    We recently changed our domain from "playex.vercel.app" to "playex.cc". This might affect:
                  </p>
                    ...
                    {[
                      {
                        ...
                        title: "Preferences",
                        desc: "Your watchlist and favorites"
                      },
                      {
