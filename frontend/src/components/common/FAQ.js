      ...
      <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>No. You do not need an account to watch Movies and TVShows on our website.</p>
          </section>
          
          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">4. Why are there ads on the player?</h2>
            <p>Ads are controlled by the embedded player providers, not by us. We do not place or manage these ads. You can try using a pop-up blocker to reduce unwanted ads, but ad blockers MAY affect the players.</p>
          </section>
