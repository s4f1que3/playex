...
const MoviesPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Movies"
        description="Browse and watch the latest movies, blockbusters, and classics on Playex. High-quality streaming of popular movies."
        ...
        <div className="container mx-auto px-4">
          <div className="relative min-h-screen">
                ...
                <div className="container relative z-30 mx-auto px-4">
                  ...
                  >
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-6 backdrop-blur-sm">
                      ...
                      <span className="text-cyan-400 font-medium">Explore Movies</span>
                    </div>
            ...
            <div className="container mx-auto px-4 -mt-20 relative z-30">
              <div className="flex flex-wrap items-center justify-end gap-4 mb-8 mt-12"> {/* Added mt-12 and increased mb-8 */}
                  ...
                  {moviesData && (
                    <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-black/20">
                      ...
                      <span className="text-gray-400">
                        Found <span className="text-cyan-400 font-medium">1M+</span> movies
                      </span>
                    </div>
                  )}
                  {isLoading && (
