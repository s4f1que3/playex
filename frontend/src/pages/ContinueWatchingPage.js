          ...
          <div className="container relative z-30 mx-auto px-4">
            ...
            >
              <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-[#82BC87]/10 border border-[#82BC87]/20 mb-6 backdrop-blur-sm">
                ...
                <span className="text-[#82BC87] font-medium">Continue Watching</span>
              </div>
        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-black/20 mb-6 w-fit">
            ...
            <span className="text-gray-400">
              Found <span className="text-[#82BC87] font-medium">{continueWatchingData.length}</span> items
            </span>
          </div>
          ...
          {continueWatchingData.length === 0 && (
            <div className="text-center py-12">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#82BC87]/10 flex items-center justify-center">
