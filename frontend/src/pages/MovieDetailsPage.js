...
const MediaDetailsPage = ({ mediaType }) => {
  ...
  // Helper function to flatten pages data
            ...
            <div className="container mx-auto px-4">
              <div className="relative bg-gray-900/90 backdrop-blur-xl rounded-2xl border border-white/5 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  {/* Load More Button for Similar Content */}
                  {similarData?.pages[0]?.total_pages > similarPage && (
                    <motion.button
                      layout
                      onClick={handleLoadMoreSimilar}
                      disabled={isFetchingMoreSimilar}
                      className="w-full mt-6 px-4 py-3 rounded-xl bg-[#E4D981]/10 hover:bg-[#E4D981]/20 
            ...
            <div className="container mx-auto px-4">
              <div className="relative bg-gray-900/90 backdrop-blur-xl rounded-2xl border border-white/5 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  {recommendationsData?.pages[0]?.total_pages > recommendedPage && (
                    <motion.button
                      layout
