          ...
          <>
            ...
            >
              <div className="relative w-full max-w-md">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-indigo-500/20 rounded-2xl filter blur-xl" />
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-400">
                        Please try using <span className="text-cyan-400 font-medium">Surge</span> or <span className="text-cyan-400 font-medium">Orion</span> instead.
                      </p>
                    </motion.div>
                    ...
                    <motion.button
                      ...
                      onClick={() => setShowUnavailableModal(false)}
                      className="w-full py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-medium hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 active:scale-95"
                    >
                      Got it
                    </motion.button>
                  </div>
          ...
          <div className="container mx-auto px-4 py-6">
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                <motion.button
                  ...
                  className="group relative px-8 py-4 rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-cyan-500/50 transition-all duration-300 shadow-2xl min-w-[280px]"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 to-indigo-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  
                  <div className="relative flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      {/* Player Icon */}
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500/20 to-indigo-500/20 flex items-center justify-center">
                        <svg
                      ...
                      <div className="text-left">
                        <p className="text-xs text-gray-400 font-medium">Current Player</p>
                        <p className="text-white font-semibold">
                          {playerType === 'nova' ? 'Nova' : playerType === 'star' ? 'Star' : playerType === 'vidlink' ? 'VidLink' : playerType === 'mapple' ? 'Surge' : 'Orion'}
                        </p>
                      </div>
                    </div>
                  ...
                  {showPlayerDropdown && (
                    <>
                      ...
                      <motion.div
                        ...
                        className="absolute top-full mt-2 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden"
                      >
                        <div className="p-2">
                          {[
                            { id: 'nova', displayName: 'Nova', icon: (
                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                            )},
                            { id: 'star', displayName: 'Star', icon: (
                              <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" />
                            )},
                            { id: 'vidlink', displayName: 'VidLink', icon: (
                              <path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z" />
                            )},
                            ...
                            >
                              ...
                              <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                                ...
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  className={`h-4 w-4 ${
                                    playerType === id ? 'text-cyan-400' : 'text-gray-400'
                                  }`}
                                  viewBox="0 0 20 20"
                                  fill="currentColor"
                                >
            ...
            <AnimatePresence>
              {(playerType === 'nova' || playerType === 'star' || playerType === 'vidlink' || playerType === 'mapple' || playerType === 'vidsrc') && (
                ...
                >
                  <div className="px-4 py-2 rounded-xl bg-cyan-500/10 border border-cyan-500/20 backdrop-blur-sm">
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          >
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
              <div className="absolute -top-20 left-1/4 w-96 h-96 bg-cyan-500/20 rounded-full filter blur-[100px] animate-pulse" />
              <div className="absolute -bottom-20 right-1/4 w-96 h-96 bg-indigo-500/20 rounded-full filter blur-[100px] animate-pulse" />
            </div>
                ...
                >
                  ...
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-white">
                      {title}
                      {episodeTitle && (
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-indigo-500 ml-2">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      {releaseYear && (
                        <Link
                          ...
                          className="group px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500/10 to-transparent hover:from-indigo-500/20 border border-indigo-500/10 hover:border-indigo-500/30 transition-all duration-300 flex items-center gap-2"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-indigo-400 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                          </svg>
                          <span className="text-indigo-400 group-hover:text-white transition-colors duration-300">{releaseYear}</span>
                        </Link>
                      )}

                      {mediaType === 'movie' && data.runtime && (
                        <div className="px-4 py-2 rounded-xl bg-gradient-to-r from-cyan-500/10 to-transparent border border-cyan-500/10 flex items-center gap-2">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-cyan-400" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                          </svg>
                          <span className="text-cyan-400">{Math.floor(data.runtime / 60)}h {data.runtime % 60}m</span>
                        </div>
                      )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {data.genres.map(genre => (
                          ...
                          >
                            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/40 to-indigo-500/40 rounded-lg opacity-0 group-hover:opacity-20 blur-[2px] transition-all duration-500" />
                            <div className="px-3 py-1 rounded-lg bg-gradient-to-r from-cyan-500/5 to-indigo-500/5 border border-white/5 relative hover:border-white/10 transition-all duration-500">
                              <span className="text-sm bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-indigo-500 group-hover:text-white/90 transition-all duration-500">
                                {genre.name}
                              </span>
                            </div>
                          </Link>
                ...
                {mediaType === 'movie' && data.belongs_to_collection && (
                  ...
                  >
                    <Link
                      ...
                      className="group relative flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-cyan-500/10 to-transparent hover:from-cyan-500/20 transition-all duration-300 border border-cyan-500/10 hover:border-cyan-500/20"
                    >
                      ...
                      <div>
                        <p className="text-sm text-cyan-400 mb-1">Part of Collection</p>
                      ...
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 text-cyan-400 ml-auto group-hover:translate-x-1 transition-transform duration-300"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {data.episode && data.episode.episode_number > 1 && (
                            <Link 
                              ...
                              className="group relative overflow-hidden rounded-xl bg-black/20 backdrop-blur-sm border border-white/5 transition-all duration-300 hover:border-cyan-500/20"
                            >
                              <div className="relative p-4 flex items-center gap-3">
                                <div className="flex items-center gap-3">
                                  <div className="relative w-8 h-8">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400 group-hover:text-cyan-400 transition-all duration-300 absolute inset-0 m-auto" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <div className="flex flex-col">
                                  <span className="text-cyan-400 text-xs font-medium mb-0.5">Previous Episode</span>
                          ...
                          >
                            <div className="relative p-4 flex items-center gap-3">
                              ...
                              <div className="flex flex-col">
                                <span className="text-cyan-400 text-xs font-medium mb-0.5">View All</span>
                                <span className="text-gray-400 group-hover:text-white transition-colors duration-300">
                              ...
                              <div className="relative p-4">
                                <div className="flex items-center justify-between gap-3">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                      <span className="text-cyan-400 text-xs font-medium mb-0.5">
                                        {data.episode.episode_number < data.seasonData?.episodes?.length
                                          ? 'Next Episode'
                                          : 'Next Season'
                                        }
