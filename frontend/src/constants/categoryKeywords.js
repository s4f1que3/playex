export const categoryKeywords = {
    ...
    romance: [
        'titanic', 'notebook', 'pride and prejudice', 'love actually',
        'bridget jones', 'pretty woman', 'notting hill', 'eternal sunshine',
        'sleepless in seattle', 'you\'ve got mail', '500 days of summer',
        'before sunrise', 'before sunset', 'before midnight', 'la la land',
        'crazy rich asians', 'the proposal', 'sweet home alabama',
        'while you were sleeping', '27 dresses', 'wedding planner',
        'maid in manhattan', 'monster in law', 'how to lose a guy',
        'fifty shades', 'twilight', 'fault in our stars', 'me before you'
    ],

    family: [
        'home alone', 'mrs doubtfire', 'nanny mcphee', 'parent trap',
        'beethoven', 'free willy', 'babe', 'charlotte\'s web',
        'stuart little', 'honey i shrunk', 'jumanji', 'zathura',
        'spy kids', 'cheaper by dozen', 'yours mine ours', 'daddy day care',
        'night at museum', 'enchanted', 'bedtime stories', 'tooth fairy'
    ],

    adventure: [
        'indiana jones', 'national treasure', 'journey center earth',
        'goonies', 'princess bride', 'neverending story', 'mummy',
        'king solomon\'s mines', 'jumanji', 'zorro', 'mask of zorro',
        'cutthroat island', 'city of ember', 'sahara', 'congo',
        'lost world', 'atlantis', 'chronicles of narnia', 'golden compass',
        'percy jackson', 'time bandits', 'hook', 'peter pan'
    ],

    disaster: [
        'twister', 'dante\'s peak', 'volcano', 'armageddon', 'deep impact',
        '2012', 'day after tomorrow', 'san andreas', 'poseidon',
        'perfect storm', 'into the storm', 'geostorm', 'greenland',
        'knowing', 'core', 'volcano', 'pompeii', 'wave', 'impossible'
    ]
};
