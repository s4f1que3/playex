export const commonStyles = {
  ...
  `,
  focusRing: `
    focus:outline-none focus-visible:ring-2 focus-visible:ring-[#82BC87] 
  ...
  `,
  buttonPrimary: `
    bg-gradient-to-r from-[#82BC87] to-[#6da972] text-white
  ...
  input: `
    ...
    placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#82BC87]
